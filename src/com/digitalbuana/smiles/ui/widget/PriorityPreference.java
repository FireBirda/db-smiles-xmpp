...
public class PriorityPreference extends EditTextPreference {
	...
	protected boolean callChangeListener(Object newValue) {
		try {
			...
			Toast.makeText(context,context.getString(R.string.account_invalid_priority),Toast.LENGTH_LONG).show();
			return false;
		}
	...
	public void setText(String text) {
		...
		try {
			if (Integer.parseInt(text) < 0)
				summary = context.getString(R.string.negative_priotiry_summary, text);
		} catch (NumberFormatException e) {
		}
		setSummary(summary);
	}
