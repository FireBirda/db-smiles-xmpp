...
import com.digitalbuana.smiles.ui.helper.ContactTitleInflater;
...
public class ContactEditor extends GroupListActivity implements
	...
	private void update() {
		...
		((TextView) findViewById(R.id.name)).setText(getString(R.string.contact_editor_title, abstractContact.getName()));
		((TextView) findViewById(R.id.status_text)).setText(StringUtils.replaceStringEquals(user));
	}
	...
	public static Intent createIntent(Context context, String account,
			String user) {
		Intent intent = new EntityIntentBuilder(context, ContactEditor.class).setAccount(account).setUser(user).build();
