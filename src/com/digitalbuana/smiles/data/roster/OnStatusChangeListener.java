...
public interface OnStatusChangeListener extends BaseManagerInterface {
	...
	void onStatusChanged(String account, String bareAddress, String resource, String statusText);

	void onStatusChanged(String account, String bareAddress, String resource, StatusMode statusMode, String statusText);
