...
public class AttentionManager implements OnPacketListener, OnLoadListener {
	...
	private final EntityNotificationProvider<AttentionRequest> attentionRequestProvider = new EntityNotificationProvider<AttentionRequest>(R.drawable.ic_stat_attention) {
	...
	public void onPacket(ConnectionItem connection, String bareAddress,
		...
		for (PacketExtension packetExtension : packet.getExtensions())
			if (packetExtension instanceof Attention) {
				...
				MessageManager.getInstance().getOrCreateChat(account, bareAddress).newAction(null, null, ChatAction.attention_requested, "", false);
