...
package org.jivesoftware.smackx.bookmark.smackx;
...
public class PrivateDataManager {
	...
	public PrivateData getPrivateData(final String elementName,
		...
		// Log.e("getPrivateData", "privateDataGet:" + privateDataGet.toXML());
		...
		collector.cancel();
		if (response == null) {
			Log.e("getPrivateData", "No response from the server.");
			throw new XMPPException("No response from the server.");
		}
		// If the server replied with an error, throw an exception.
		else if (response.getType() == IQ.Type.ERROR) {
			Log.e("getPrivateData", response.getError().getMessage());
			throw new XMPPException(response.getError());
		}

		Log.e("getPrivateData", "response:" + response.toXML());
