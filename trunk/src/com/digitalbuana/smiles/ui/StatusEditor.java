...
import com.digitalbuana.smiles.data.account.SavedStatus;
import com.digitalbuana.smiles.data.account.StatusMode;
import com.digitalbuana.smiles.data.intent.AccountIntentBuilder;
import com.digitalbuana.smiles.ui.adapter.StatusEditorAdapter;
import com.digitalbuana.smiles.ui.adapter.StatusModeAdapter;
...
public class StatusEditor extends ManagedListActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (account == null)
			...
			setTitle(getString(R.string.status_editor_for, AccountManager.getInstance().getVerboseName(account)));
