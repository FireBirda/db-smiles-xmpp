...
private int mIndicatorSize = 9;//default 7
	...
	private void initPageControl()
	{
		...
		((ShapeDrawable) activeDrawable).getPaint().setColor(a.getColor(0, Color.BLUE));
		((ShapeDrawable) inactiveDrawable).getPaint().setColor(a.getColor(1, Color.DKGRAY));
