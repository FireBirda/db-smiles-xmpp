...
import com.digitalbuana.smiles.data.extension.muc.RoomInvite;
...
public class MUCEditor extends ManagedActivity implements View.OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			if (account != null && room != null) {
				...
				passwordView.setText(MUCManager.getInstance().getPassword(account, room));
			}
		}
		if (account == null) {
	...
	private void sendBookmark(String value, String account){
		
		Map<String, String> parms = new HashMap<String, String>();
		parms.put("r", AppConstants.ofSecret);
		parms.put("bn", value+" by " + account);
		parms.put("bv", value);
		parms.put("bu", account);
	...
	protected Dialog onCreateDialog(int id) {
		...
		case DIALOG_MUC_INVITE_ID:
			return new ConfirmDialogBuilder(this, DIALOG_MUC_INVITE_ID, this).setMessage(com.digitalbuana.smiles.utils.StringUtils.replaceStringEquals(roomInvite.getConfirmation())).create();
		default:
			return null;
		}
	}
