...
//
//public class FileTransferKuRequest extends BaseEntity implements
//		EntityNotificationItem {
//
//	private String textNya=null;
//	
//	public FileTransferKuRequest(String account, String user, String text) {
//		super(account, user);
//		if(textNya!=null){
//			this.textNya = text;
//		}
...
//		return createAttentionRequestIntent.createAttentionRequestIntent( Application.getInstance(), account, user);
//	}
//
//	@Override
