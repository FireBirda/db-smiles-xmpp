...
import com.digitalbuana.smiles.ui.adapter.ComparatorByName;
import com.digitalbuana.smiles.ui.adapter.ComparatorByStatus;
...
public class SettingsManager implements OnInitializedListener,
	...
	public static enum InterfaceTheme {
		dark, light, colorfull, transparant, ;
	}

	public static enum EventsMessage {
		none, chat, chatAndMuc;
	};
	...
	public static boolean contactsShowAccounts() {
		// return getBoolean(R.string.contacts_show_accounts_key,false);
		return false;
	}
	...
	public static boolean connectionLoadVCard() {
		return getBoolean(R.string.connection_load_vcard_key, true);
	}
	...
	public static InterfaceTheme interfaceTheme() {
		...
		if (Application.getInstance()
			...
			return InterfaceTheme.colorfull;
		else
			throw new IllegalStateException();
	}
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
		...
		if (key.equals(Application.getInstance().getString(
			...
			SmilesService.getInstance().changeForeground();
		} else if (key.equals(Application.getInstance().getString(
